...
def render_mesh(
    ...
    with dr.DepthPeeler(ctx, v_pos_clip, mesh.t_pos_idx.int(), [resolution*spp, resolution*spp]) as peeler:
        for _ in range(num_layers):
            ...
            # img = rast.cpu().numpy()[0, ::-1, :, :] # Flip vertically.
            ...
            # # 创建一个 EXR 文件
            # index = 0
            # exr = OpenEXR.OutputFile('rast' + str(index) + '.exr', OpenEXR.Header(512, 512))
            ...
            # print("Saving to rast"+str(index)+'.exr.')
